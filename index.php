...
//Mostrar los valores del vector con número pares
        echo "<br>Vector con número pares: <br>";
        for($i=0;$i<count($vectorpar);$i++){
            echo $vectorpar[$i] . "<br>";
        }

//Mostrar los valores del vector con número impares
echo "<br>Vector con número impares: <br>";
